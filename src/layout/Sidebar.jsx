  ...
  return (
    <div className='sticky top-0 pt-[110px] p-8 bg-dark border-r max-h-[100vh] overflow-auto pb-22 w-full max-w-[300px] border-gray-900'>
      ...
      <ul>
        ...
        {user?.is_admin == 1  ?
          <li>
            <Link className='text-gray-200 mb-2 py-[13px] px-[13px] border border-gray-900 rounded-2xl bg-dark flex items-center' to={'/employees'} ><FaUsers className='me-2' size={'1.4rem'} /> Staff 
          </Link>
          </li>
          : ''
         }
        ...
        {user?.is_admin == 1 || user?.role == 2 ?
          <li>
            <Link className='text-gray-200 mb-2 py-[13px] px-[13px] border border-gray-900 rounded-2xl bg-dark flex items-center' to={'/accounts/orders'} ><VscGraphLine className='me-2' size={'1.4rem'} /> Accounting 
          </Link>
          </li> 
        : "" }
