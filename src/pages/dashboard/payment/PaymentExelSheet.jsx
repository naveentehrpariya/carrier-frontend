      ...
      data.map((e, i) => {
         if(type === 'customer' ){
            loadedData.push({
               ...
               'Amount' :formattedValue((e?.input_total_amount > 0 ? (e?.input_currency||'usd') : (e?.revenue_currency||'usd')), (e?.input_total_amount > 0 ? e.input_total_amount : e?.total_amount)),
               ...
               loadedData.push({
                  ...
                  'Amount' :formattedValue((e?.input_carrier_amount > 0 ? (e?.input_currency||'usd') : (e?.revenue_currency||'usd')), (e?.input_carrier_amount > 0 ? e.input_carrier_amount : e?.carrier_amount)),
