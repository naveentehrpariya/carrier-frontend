            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-x-6 gap-y-5 px-4 md:px-5 py-4'>
              ...
              <div className='min-w-0 text-sm xl:max-w-[260px] xl:ms-auto w-full'>
                ...
                <div className='flex items-center justify-between gap-3'>
                  ...
                  <span className='font-semibold text-green-500 tabular-nums truncate' title={`${order?.total_amount ?? 0}`}>
                ...
                <div className='flex items-center justify-between gap-3 mt-1.5'>
                  ...
                  <span className='font-semibold text-orange-500 tabular-nums truncate' title={`${order?.carrier_amount ?? 0}`}>
                ...
                <div className='flex items-center justify-between gap-3 mt-1.5 pt-1.5 border-t border-gray-800/60'>
                  ...
                  <span className={`font-semibold tabular-nums truncate ${Number(order?.profit) < 0 ? 'text-red-400' : 'text-emerald-400'}`} title={`${order?.profit ?? 0}`}>
