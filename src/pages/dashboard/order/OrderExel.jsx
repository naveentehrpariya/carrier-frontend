...
const downloadExel = async (t) => {
  ...
  data.forEach((e, i) => {
    loadedData.push({
      ...
      'Customer Amount': formattedValue((e?.input_total_amount > 0 ? (e?.input_currency || 'usd') : (e?.revenue_currency || 'usd')), (e?.input_total_amount > 0 ? e.input_total_amount : e?.total_amount)),
      ...
      'Carrier Amount': formattedValue((e?.input_carrier_amount > 0 ? (e?.input_currency || 'usd') : (e?.revenue_currency || 'usd')), (e?.input_carrier_amount > 0 ? e.input_carrier_amount : e?.carrier_amount)),
