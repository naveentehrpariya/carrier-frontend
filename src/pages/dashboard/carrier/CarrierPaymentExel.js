         ...
         data.map((e, i) => {
            if(t === 'all' ){
               loadedData.push({
                  ...
                  'Total Amount' :formattedValue((e?.input_carrier_amount > 0 ? (e?.input_currency||'usd') : (e?.revenue_currency||'usd')), (e?.input_carrier_amount > 0 ? e.input_carrier_amount : e?.carrier_amount)),
               });
            } else {
